...
import { AnalysisArticleBody, AnalysisArticleHeader } from '@astra-spec/theme-astra/shell';
    ...
    >
      <BusyScopeProvider>
        <ExecuteScopeProvider enable={compute?.enabled ?? false} contents={article}>
          <AnalysisArticleHeader frontmatter={project} hideAuthors={hide_authors}>
          ...
          <AnalysisArticleBody isIndex={isIndex}>
            {!isIndex && (
