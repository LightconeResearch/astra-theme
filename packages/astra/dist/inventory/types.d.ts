import type { SerializedDecision, SerializedFinding, SerializedInput, SerializedInsight, SerializedOutput } from '@astra-spec/store-types';
export type InventoryKind = 'analysis' | 'input' | 'decision' | 'output' | 'finding' | 'prior_insight';
...
export type InventoryOpenReference = InventoryRecordReference | InventoryPaperReference;
...
export type InventoryOutputRecord = InventoryRecord & SerializedOutput & {
    resultPreview?: string;
    table_rows_total?: number;
    table_columns_total?: number;
    table_preview_omitted?: 'project_size_budget';
