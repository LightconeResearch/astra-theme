...
export function PaperPdfViewer({
  ...
  useEffect(() => {
    ...
    let textLayer: { render: () => Promise<void>; cancel: () => void; textDivs: HTMLElement[]; textContentItemsStr: string[] } | undefined;
  ...
  return (
    <div className="inventory-paper-pdf" aria-label={`PDF viewer for ${title}`}>
      <div className="inventory-paper-pdf__toolbar">
        ...
        <a href={pdfUrl.split('#')[0]} target="_blank" rel="noreferrer" aria-label="Open PDF in a new tab">Open ↗</a>
      </div>
